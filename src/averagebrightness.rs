...
pub trait AverageBrightness {
    ...
    fn gray_intensity_single_val(&self,to_picture_f32: PictureF32)->f32;
...
impl AverageBrightness for PictureF32 {
    ...
    fn gray_intensity_single_val(&self,to_picture_f32: PictureF32)->f32{
        ...
        if to_picture_f32.color_channel_count == 3 {
            r = to_picture_f32.data[count_colour ] ; //  wert1 -> Rot
            g = to_picture_f32.data[count_colour + 1]; // wert2 -> Grün
            b = to_picture_f32.data[count_colour + 2]; // wert3 -> Blau
        }
        else if to_picture_f32.color_channel_count == 4 {
             r = to_picture_f32.data[count_colour]; // wert1 -> Rot
             g = to_picture_f32.data[count_colour + 1 as usize]; //  wert2 -> Grün
             b = to_picture_f32.data[count_colour + 2 as usize]; //  wert3 -> Blau
        }
        let singel_pixel_gray =((0.3 * r) + (0.59 * g) + (0.11 * b));
